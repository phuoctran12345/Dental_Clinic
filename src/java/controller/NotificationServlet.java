...
public class NotificationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        List<Notification> unreadNotifs = notifDAO.getUnreadNotifications(user.getId());
        request.setAttribute("unreadNotifs", unreadNotifs);
        
        // Lấy 10 thông báo gần nhất
        List<Notification> notifications = notifDAO.getRecentNotifications(user.getId(), 10);
