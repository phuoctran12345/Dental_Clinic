...
public class EmailService {
    ...
    // OPTION 1: Gmail
    private static final String FROM_EMAIL = "choheo.soss@gmail.com"; // Email của bạn
    private static final String FROM_PASSWORD = "kcwx lczs qhga vdeo"; // ⚠️ CẬP NHẬT APP PASSWORD MỚI TẠI ĐÂY!   
