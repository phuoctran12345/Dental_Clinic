...
<head>
    ...
    <script>
        ...
        function updateCountdown() {
            ...
            if (countdown <= 0) {
                window.location.href = 'DoctorAppointmentsServlet';
            }
            countdown--;
        }
...
<body>
    <div class="success-container">
        ...
        <div class="action-buttons">
            <a href="DoctorAppointmentsServlet" class="btn btn-primary">
                🏠 Về Trang Chính
            </a>
            <a href="doctor_tongquan.jsp" class="btn btn-secondary">
                📊 Dashboard
            </a>
        </div>
    </div>
