    ...
    <div class="container">
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-md-6 col-lg-5">
                <!-- Back Link -->
                <div class="mb-3">
                    <a href="/doctor/ResetPasswordServlet?action=forgot-password" class="back-link">
                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="resend-info">
                            ...
                            <a href="/doctor/ResetPasswordServlet?action=forgot-password" class="btn btn-outline-secondary btn-sm">
            ...
            if (countdownElement && timeLeft > 0) {
                const timer = setInterval(function() {
                    if (timeLeft <= 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = '/doctor/ResetPasswordServlet?action=forgot-password';
                        }, 2000);
                    } else {
