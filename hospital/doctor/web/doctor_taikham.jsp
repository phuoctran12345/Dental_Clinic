    ...
    <body>
        ...
        <div class="taikham_container">
            <div class="taikham-header">
                <i class="fas fa-redo-alt"></i> Tái khám
            </div>
            ...
            <div class="taikham-search">
                ...
                <span style="color: #666; font-size: 14px;">
                    <i class="fas fa-info-circle"></i> Hiển thị những bệnh nhân đã hoàn tất khám và chưa có lịch tái khám
                </span>
            </div>
            ...
            <div id="patientList">
                ...
                %>
                    <div class="no-patients">
                        ...
                        <h4>Không có bệnh nhân nào cần tái khám</h4>
                        <p>Hiện tại chưa có bệnh nhân nào đã hoàn tất khám và chưa có lịch tái khám.</p>
                    </div>
                <%
                    }
                %>
        ...
        <div class="reexam-popup" id="reexamPopup">
            ...
            <form action="ReexaminationServlet" method="post" id="reexamForm">
