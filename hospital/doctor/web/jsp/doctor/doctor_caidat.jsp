                            ...
                            <div class="form-group">
                                <c:choose>
                                    <c:when test="${not empty doctor}">
                                        <form action="/doctor/doctor_caidat" method="post">
                                            ...
                                            <div class="form-group text-center mt-3">
                                                <a href="/doctor/jsp/doctor/doctor_changepassword.jsp" class="btn btn-warning">
                                        ...
                                        <div class="extra">
                                            <a href="/doctor/doctor_trangcanhan">Quay lại hồ sơ</a>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
