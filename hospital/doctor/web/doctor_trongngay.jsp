    ...
    <body>
                ...
                if (appointments != null) {
                    for (Appointment app : appointments) {
                        if ("Đã đặt".equalsIgnoreCase(app.getStatus())) {
                            waitingCount++;
                        } else if ("Hoàn tất".equalsIgnoreCase(app.getStatus())) {
                            completedCount++;
                        } else if ("Đã hủy".equalsIgnoreCase(app.getStatus())) {
                            cancelledCount++;
                        }
            ...
            <div class="cards">
                    ...
                    <div class="single-card">
                        ...
                        <div class="info">
                            ...
                            <div class="info-details">
                                <p><strong>Bệnh nhân ID: <%=appointment.getPatientId()%></strong></p>
                        ...
                        <div class="actions">
                            <a href="phieukham.jsp?appointmentId=<%=appointment.getAppointmentId()%>" class="btn-blue">
                                <i class="fas fa-file-medical"></i> Tạo phiếu khám
                            </a>
                            <form method="post" action="updateAppointmentStatus" style="display: inline;">
                ...
                <div class="cards-column">
                    <%
                        ...
                        if (appointments != null && !appointments.isEmpty()) {
                            for (Appointment appointment : appointments) {
                                ...
                                if ("Hoàn tất".equalsIgnoreCase(status)) {
                    ...
                    <div class="single-card">
                        ...
                        <div class="actions">
                            <a href="ViewReportServlet?appointmentId=<%=appointment.getAppointmentId()%>" class="btn-gray">
        ...
        <script>
            ...
            function viewCompletedAppointments() {
                ...
                window.location.href = 'completedAppointments';
            }
