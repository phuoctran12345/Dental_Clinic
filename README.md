...
| Tên Servlet | JSP | Đường dẫn | Chức năng chính |
|-------------|-----|-----------|-----------------|
| `DoctorHomePageServlet` | doctor_tongquan.jsp | /jsp/doctor/doctor_tongquan.jsp | Trang tổng quan, thống kê, danh sách hẹn hôm nay |
| `DoctorProfileServlet` | doctor_trangcanhan.jsp | /doctor_trangcanhan | Xem hồ sơ cá nhân bác sĩ |
| `EditDoctorServlet` | doctor_caidat.jsp | /EditDoctorServlet | Chỉnh sửa thông tin cá nhân bác sĩ |
| `DoctorChangePasswordServlet` | doctor_changepassword.jsp | /DoctorChangePasswordServlet | Đổi mật khẩu |
| `DoctorScheduleServlet` | doctor_trongtuan.jsp, doctor_lichtrongthang.jsp | /doctor-schedule | Xem lịch làm việc cá nhân (tuần/ngày) |
| `DoctorRegisterScheduleServlet` | doctor_dangkilich.jsp | /DoctorRegisterScheduleServlet | Đăng ký lịch làm việc, xin nghỉ |
| `DoctorScheduleConfirmServlet` | (nội bộ) | (nội bộ) | Xác nhận lịch làm việc, lấy lịch trống |
| `DoctorAppointmentsServlet` | doctor_trongngay.jsp | (nội bộ) | Xem danh sách cuộc hẹn trong ngày |
| `CompletedAppointmentsServlet` | doctor_ketqua.jsp | /completedAppointments | Xem danh sách cuộc hẹn đã hoàn thành |
| `CreateMedicalReportServlet` | doctor_phieukham.jsp | (nội bộ) | Hiển thị form tạo phiếu khám |
| `MedicalReportServlet` | (nội bộ) | (nội bộ) | Tạo báo cáo y tế, đơn thuốc |
| `ViewReportServlet` | doctor_viewMedicalReport.jsp | /ViewReportServlet | Xem chi tiết báo cáo y tế |
| ... | ... | ... | ... |
