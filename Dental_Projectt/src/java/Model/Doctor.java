...
public  Doctor() {
    ...
    public Doctor(int doctorId, int userId, String fullName, String phone, String address, Date dateOfBirth, String gender, String specialty, String licenseNumber, Date createdAt) {
