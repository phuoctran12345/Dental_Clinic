...
public class BillDetailsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet BillDetailsServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet BillDetailsServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        Gson gson = new Gson();
        java.lang.reflect.Type type = new TypeToken<Map<String, BillDetails>>() {}.getType();
        ...
        try (java.sql.Connection con = DBConnection.getConnection()) {
            int billID = BillDAO.getLastBillID(con); // Lấy Bill_ID mới nhất
