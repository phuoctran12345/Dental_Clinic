...
<html lang="vi">
    ...
    <body>
        ...
        <div class="scheduler">
            ...
            <button class="apointment hidden" id="btnSelf">Đặt cho bản thân</button>
            <button class="apointment hidden" id="btnRelative">Đặt cho người thân</button>
    ...
    calendar.addEventListener("click", function (e) {
        if (e.target.classList.contains("day")) {
            ...
            // Ẩn lại hai nút xác nhận
            btnSelf.classList.add("hidden");
            btnRelative.classList.add("hidden");
            ...
            // Hiển thị khung giờ của ngày đã chọn
            timePicker.querySelectorAll(".time-slot").forEach(slot => {
    ...
    timePicker.querySelectorAll(".time-slot").forEach(slot => {
        slot.addEventListener("click", () => {
            ...
            // Hiện hai nút xác nhận
            btnSelf.classList.remove("hidden");
            btnRelative.classList.remove("hidden");
        });
    });
    ...
    btnRelative.addEventListener("click", () => {
        ...
        const scheduleId = selectedSlot.getAttribute("data-schedule-id");
        const workDate = selectedSlot.getAttribute("data-work-date");
        const startTime = selectedSlot.getAttribute("data-start-time");

        // Điều hướng sang form nhập người thân
        window.location.href = `form-nhap-than.jsp?schedule_id=${scheduleId}&work_date=${workDate}&start_time=${startTime}`;
    });
</script>
