...
public class Patients {
    ...
    public Patients(int patientId, int userId, String fullName, String phone, Date dateOfBirth, String gender, Date createdAt, String avatar, int bookedByUserId) {
    ...
    public String toString() {
        return "Patients{" + "patientId=" + patientId + ", userId=" + userId + ", fullName=" + fullName + ", phone=" + phone + ", dateOfBirth=" + dateOfBirth + ", gender=" + gender + ", createdAt=" + createdAt + ", avatar=" + avatar + ", bookedByUserId=" + bookedByUserId + '}';
    }
