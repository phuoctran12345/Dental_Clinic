...
public class ConfirmRelativeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int newPatientId = HospitalDB.findOrInsertRelativePatient(fullName, dateOfBirth, gender);
        ...
        boolean success = HospitalDB.insertAppointmentForRelative(scheduleId, newPatientId, workDate, startTime, userId);
        if (success) {
