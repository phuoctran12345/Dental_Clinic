...
<% // Lấy dữ liệu từ servlet
    ...
    List<Map<String, Object>> waitingPatients
    ...
    Map<String, Object> doctorStats = (Map<String, Object>) request.getAttribute("doctorStats");
            ...
            <div class="visit-count">
                ...
                <div class="patient-list">
                    <% if (waitingPatients != null
                            ...
                            for (Map<String, Object> patientData : waitingPatients) {
                    %>
                    <div class="patient">
