...
INSERT INTO [dbo].[Appointment] (patient_id, doctor_id, work_date, slot_id, status, reason,doctor_name,previous_appointment_id) VALUES
    (1, 5, '2025-12-20', 2, N'booked', N'Khám tổng quát - Lấy cao răng','toan',1),
	(1, 6, '2025-12-20', 2, N'booked', N'Khám tổng quát - Lấy cao răng','tran',1),
	(1, 7, '2025-12-20', 2, N'booked', N'Khám tổng quát - Lấy cao răng','ha',1),
	(1, 8, '2025-12-20', 2, N'booked', N'Khám tổng quát - Lấy cao răng','linh',1),
    (2, 5, '2025-12-21', 1, N'booked', N'Tư vấn niềng răng cho con','nam',1),
    (3, 6, '2025-12-24', 1, N'booked', N'Trám răng sâu','hai',1),
    (4, 8, '2025-12-25', 2, N'booked', N'Tái khám niềng răng','khanh',1);
...
values ( /* user_id */ 4 ,/* full_name */ N'Nguyen Do Phuc Toan' ,/* phone */ N'0123456789' ,/* address */ N'123 Đường ABC, Quận 1, TP.HCM' ,/* date_of_birth */ '1985-06-15' ,/* gender */ N'male' ,/* specialty */ N'Chuyên khoa răng miệng ' ,/* license_number */ N'BACSITOAN001' ,/* created_at */ '2025-05-24 03:25:49.890' ,/* status */ N'active' ,/* avatar */ null  ), 
( /* user_id */ 8 ,/* full_name */ N'BS. Nguyễn Văn An' ,/* phone */ N'0901234567' ,/* address */ N'123 Đường Nguyễn Trãi, Q1, HCM' ,/* date_of_birth */ '1980-01-15' ,/* gender */ N'male' ,/* specialty */ N'Nha khoa tổng quát' ,/* license_number */ N'NK001' ,/* created_at */ '2025-06-10 17:09:53.247' ,/* status */ N'active' ,/* avatar */ null  ), 
( /* user_id */ 9,/* full_name */ N'BS. Trần Thị Bích' ,/* phone */ N'0912345678' ,/* address */ N'456 Đường Lê Văn Sỹ, Q3, HCM' ,/* date_of_birth */ '1985-05-20' ,/* gender */ N'female' ,/* specialty */ N'Chỉnh nha - Niềng răng' ,/* license_number */ N'NK002' ,/* created_at */ '2025-06-10 17:09:53.247' ,/* status */ N'active' ,/* avatar */ null  ), 
( /* user_id */ 10 ,/* full_name */ N'BS. Lê Minh Cường' ,/* phone */ N'0923456789' ,/* address */ N'789 Đường Võ Văn Tần, Q3, HCM' ,/* date_of_birth */ '1978-12-10' ,/* gender */ N'male' ,/* specialty */ N'Phẫu thuật hàm mặt' ,/* license_number */ N'NK003' ,/* created_at */ '2025-06-10 17:09:53.247' ,/* status */ N'active' ,/* avatar */ null  );
...
SELECT * FROM Staff; -- Phải trả về 3 bản ghi
SELECT s.*, u.email FROM Staff s LEFT JOIN users u ON s.user_id = u.user_id; -- Phải trả về 3 bản ghi với email
SELECT * FROM Doctors; -- Phải trả về 4 bản ghi
SELECT d.*, u.email FROM Doctors d LEFT JOIN users u ON d.user_id = u.user_id; -- Phải trả về 4 bản ghi với email