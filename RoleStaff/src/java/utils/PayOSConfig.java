...
public class PayOSConfig {
    ...
    public static final String CLIENT_ID = "Phuoc dep zai";
    public static final String API_KEY = "Phuoc dep zai";
    public static final String CHECKSUM_KEY = "Phuoc dep zai";
