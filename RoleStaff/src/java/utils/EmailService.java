...
public class EmailService {
    ...
    // Cấu hình email gửi (thay đổi thông tin này)
    // OPTION 1: Gmail
    private static final String FROM_EMAIL = "Phuoc dep zai"; // Email của bạn
    private static final String FROM_PASSWORD = "Phuoc dep zai"; // ⚠️ CẬP NHẬT APP PASSWORD MỚI TẠI ĐÂY!   
    private static final String SMTP_HOST = "Phuoc dep zai";
    private static final String SMTP_PORT = "Phuoc dep zai";
