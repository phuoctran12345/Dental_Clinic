...
public class UserDAO {
    ...
    private static final String CHECK_USERNAME = "SELECT 1 FROM Users WHERE username = ?";
    private static final String REGISTER_PATIENT = "INSERT INTO Users (username, email, password_hash, role) VALUES (?, ?, ?, 'patient')";
     ...
     */
    public int registerUserInstance(String username, String email, String password, String role) throws SQLException {
        int generatedId = 0;
        try {
            conn = DBContext.getConnection();
            if (conn != null) {
     ...
     */
    public boolean isUsernameExistsInstance(String username) throws SQLException {
     ...
     */
    public static int registerPatient(String username, String email, String password) {
    ...
    public static boolean isUsernameExists(String username) {
        try {
            UserDAO dao = new UserDAO();
            return dao.isUsernameExistsInstance(username);
        } catch (SQLException e) {
            e.printStackTrace();
            return false;
        }
