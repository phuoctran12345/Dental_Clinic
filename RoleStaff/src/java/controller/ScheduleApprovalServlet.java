...
@WebServlet(name = "ScheduleApprovalServlet", urlPatterns = {"/jsp/manager/manager_phancong"})
public class ScheduleApprovalServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect(request.getContextPath() + "/jsp/manager/manager_phancong");
    }
} 