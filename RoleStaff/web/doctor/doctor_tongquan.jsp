            ...
            <%@ include file="/includes/doctor_menu.jsp" %>
                <%@ page import="dao.DoctorDAO" %>
                    <%@ page import="model.Doctor" %>
                        ...
                        <% session.setAttribute("user_id", 1); // Lấy userId từ session Integer userId=(Integer)
                            session.getAttribute("user_id"); Doctor doctor=null; if (userId !=null) {
                                ...
                                <div class="dashboard">
                                    ...
                                    <div class="status-card">
                                        ...
                                        <div class="note">
                                            ...
                                            Người sử dụng hệ thống sẽ dễ dàng đặt lịch khám hoặc yêu cầu tư vấn hơn khi
                                            có bác sĩ đang trực!
                                        </div>
                                    </div>
                                    ...
                                    <div class="doctor-card">
                                        ...
                                        <div class="card-body">
                                            <% if (doctor !=null) { %>
                                                ...
                                                <p><i class="fa-solid fa-venus-mars"></i> Giới tính: <%=
                                                        doctor.getGender() %>
                                                </p>
                                                ...
                                                <p><i class="fa-solid fa-phone"></i> Số điện thoại: <%=
                                                        doctor.getPhone() %>
                                                </p>
                                                <% } else { %>
                                    ...
                                    <div class="consultations">
                                        ...
                                        <div class="consultation-item">
                                            ...
                                            <div class="consultation-content">
                                                ...
                                                <div class="consultation-message">Hiện tại em đang muốn khám tổng quát,
                                                    bác sĩ có thể...</div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="consultation-item">
                                            ...
                                            <div class="consultation-content">
                                                ...
                                                <div class="consultation-message">Tư vấn giúp em về tình hình sức khỏe
                                                    hiện tại của em...</div>
                                            </div>
                                        </div>
                                    </div>
