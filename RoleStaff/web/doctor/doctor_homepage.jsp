                    ...
                    `;
                                    ...
                                    <body>
                                        ...
                                        <% int appointmentId=Integer.parseInt(request.getParameter("appointment_id"));
                                            int patientId=Integer.parseInt(request.getParameter("patient_id")); User
                                            user=(User) session.getAttribute("user"); // bác sĩ %>
                                            <form action="${pageContext.request.contextPath}/InputMedicalReportServlet"
                                                method="post">
                                                ...
                                                <textarea name="diagnosis" rows="3" cols="50"
                                                    required></textarea><br><br>

                                                <label>Phác đồ điều trị:</label><br>
                                                <textarea name="treatment_plan" rows="3" cols="50"
                                                    required></textarea><br><br>
                                                ...
                                                <input type="number" id="numMedicines" name="numMedicines" min="1"
                                                    max="10" required onchange="renderMedicineFields()">
