        ...
        <div class="menu" id="sideMenu">
            ...
            <div class="menu_group">
                ...
                <div class="dropdown_list">
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_danhsach.jsp">• Danh sách nhân
                        viên</a>
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_lichtrinh.jsp">• Lịch trình</a>
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_baocao.jsp">• Báo cáo</a>
                </div>
            </div>
            ...
            <div class="menu_group">
                ...
                <div class="dropdown_list">
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_lichtrongthang.jsp">• Lịch trong
                        tháng</a>
            ...
            <div class="menu_group">
                ...
                <div class="dropdown_list">
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_trangcanhan.jsp">• Trang cá nhân</a>
                    <a href="${pageContext.request.contextPath}/jsp/manager/manager_caidat.jsp">• Cài đặt</a>
                </div>
            </div>
        </div>
    </body>