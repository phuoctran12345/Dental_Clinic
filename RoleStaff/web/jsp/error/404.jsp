            ...
            <div class="pos_page">
                <div class="container">
                    ...
                    <div class="pos_page_inner">
                        <!--header area -->
                        <jsp:include page="/jsp/patient/header.jsp" />
                        <!--header end -->
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="error_form">
                                        ...
                                        <p>Sorry but the page you are looking for does not exist, have been<br> removed,
                                            name changed or is temporarity unavailable.</p>
