                        ...
                        <div class="main-content">
                            ...
                            <div class="queue-card">
                                ...
                                <div class="queue-list">
                                    ...
                                    <div
                                        style="background: #f0f0f0; padding: 10px; margin: 10px; border: 1px solid #ccc; font-family: monospace;">
                                        <strong>🔍 JSP DEBUG:</strong><br />
                                        appointments size: ${appointments.size()}<br />
                                        appointments null? ${appointments == null}<br />
                                        empty? ${empty appointments}<br />
                                                        ...
                                                        <div class="patient-info">
                                                            <div class="info-row">
                                                                ...
                                                                <c:choose>
                                                                    ...
                                                                    <c:when
                                                                        test="${appointment.status == 'Chờ xác nhận' || appointment.status == 'ĐANG GIỮ CHỖ'}">
