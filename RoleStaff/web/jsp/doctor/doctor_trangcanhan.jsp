                ...
                <div class="main-container">
                    ...
                    <div class="doctor-trangcanhan">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="dateOfBirth" value="<%= (doc.getDateOfBirth() != null) ? new java.text.SimpleDateFormat("dd/MM/yyyy").format(doc.getDateOfBirth()) : "Chưa cập nhật" %>" readonly>

                            <label for="gender">Giới Tính</label>
                            <input type="text" id="gender" value="<%= (doc.getGender() != null ? doc.getGender() : "Chưa cập nhật") %>" readonly>

                            <label for="status">Trạng Thái</label>
                            <input type="text" id="status" value="<%= (doc.getStatus() != null ? doc.getStatus() : "Chưa cập nhật") %>" readonly>
                            <% } else { %>
