                    ...
                    <%@include file="staff_menu.jsp" %>
                                            ...
                                            <button class="accordion-button collapsed p-3" type="button"
                                                ...
                                                <div
                                                    ...
                                                    <div class="mb-2 mb-md-0">
                                                        <strong class="text-primary me-3">${bill.billId}</strong>
                                                ...
                                                <c:forEach items="${bill.installmentDetails}" var="inst">
                                                    <div class="row installment-row align-items-center gx-3">
                                                        ...
                                                        <div class="col-md-4">Phải trả:
                                                            <fmt:formatNumber value="${inst.amountDue}" type="currency"
                                                        ...
                                                        <div class="col-md-3 text-end">
                                                            <c:if test="${inst.status ne 'PAID'}">
                                                                <button class="btn btn-sm btn-success"
                                                                    ...
                                                                    <i class="fas fa-hand-holding-dollar"></i> Trả kỳ
                                                                </button>
                                                            </c:if>
                                                        </div>
                                                    </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <input type="hidden" id="pay_billId"><input type="hidden" id="pay_period">
                                        ...
                                        <div class="mb-3"><label for="pay_amount" class="form-label">Số tiền thanh
                                                toán:</label><input type="number" id="pay_amount" class="form-control">
                                        </div>
                        ...
                        <script>
                            ...
                            function submitPayment() {
                                ...
                                fetch('/RoleStaff/StaffPaymentServlet?action=payInstallment', {
                                    method: 'POST',
