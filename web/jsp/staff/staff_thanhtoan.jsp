                    ...
                    <body>
                        <div class="main-content">
                            ...
                            <div class="bills-card">
                                <div class="bills-header">
                                    ...
                                    <p class="bills-subtitle">Hiển thị <span id="displayCount">${totalBills}</span> hóa
                                        đơn</p>
                                </div>
                            ...
                            <div class="card-footer bg-light" id="billsPaginationContainer" style="display: none;">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="text-muted small">
                                        Trang <span id="billsCurrentPage">1</span> / <span id="billsTotalPages">1</span>
                                        <span class="ms-3">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="createInvoiceForm" action="StaffPaymentServlet" method="post">
                                            ...
                                            <div class="border rounded" style="max-height: 200px; overflow-y: auto;">
                                                ...
                                                <div class="service-item p-3 border-bottom d-flex align-items-center gap-3"
                                                    ...
                                                    <input type="checkbox" class="form-check-input"
                                                        name="selectedServices" value="1" data-price="3000000" checked
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="paymentAmount"
                                                            id="paymentAmount" value="3000000"
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="submitCreateInvoice()">
                        ...
                        <script>
                            ...
                            function closeCreateModal() {
                                ...
                                if (totalAmountEl) totalAmountEl.textContent = '3.000.000 VNĐ';
                                if (currentCountEl) currentCountEl.textContent = '1';
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="downPaymentPercent" class="form-label">Tỷ lệ đặt cọc
                                                        (%):</label>
                                                    <input type="number" id="downPaymentPercent" class="form-control"
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="installmentPeriodsSelect" class="form-label">Số kỳ trả
                                                        góp:</label>
