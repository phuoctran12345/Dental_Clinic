            ...
            <style>
                * {
                ...
                .dropdown-list {
                    ...
                    top: 100%;
                    background: #fff;
                    box-shadow: 0 4px 16px rgba(78, 128, 238, 0.13), 0 1.5px 6px rgba(0, 0, 0, 0.07);
                    border-radius: 14px;
                    min-width: 240px;
                    z-index: 10;
                    padding: 10px 0;
                ...
                .dropdown-item:hover {
                    background: #e3f0ff;
                    color: #1976d2;
                    box-shadow: 0 2px 8px rgba(78, 128, 238, 0.10);
                }
            </style>
        </head>
                ...
                <div class="menu">
                    ...
                    <div class="dropdown-menu-custom">
                        ...
                        <ul class="dropdown-list">
                            ...
                            <li>
                                <a href="${pageContext.request.contextPath}/chat.jsp" class="dropdown-item">
                                    <i class="fa-solid fa-user-md"></i>
                                    <span>Nhắn tin trực tiếp với bác sĩ</span>
                                </a>
                            </li>
                        </ul>
                    </div>
