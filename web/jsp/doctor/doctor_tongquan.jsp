...
<%@ page import="controller.DoctorHomePageServlet" %>
...
<%!
    ...
    public String getTimeSlot(int slotId) {
        return controller.DoctorHomePageServlet.getTimeSlot(slotId);
    }
%>
        ...
        <div class="dashboard">
            ...
            <div class="waiting-card">
                ...
                <div class="patient">
                    ...
                    <button class="status-btn" onclick="window.location.href = 'doctor_phieukham.jsp?appointmentId=<%= appointment.getAppointmentId()%>'">
                        <%= timeSlot%>
                    </button>
                </div>
                ...
                <a href="${pageContext.request.contextPath}/DoctorAppointmentsServlet" class="view-all">Xem tất cả</a>
            </div>
            ...
            <div class="recent-bookings">
                ...
                <% }%>
                <a href="${pageContext.request.contextPath}/cancelledAppointments" class="view-all">Xem tất cả</a>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (statusToggle && statusLabel) {
        statusToggle.addEventListener('change', function () {
            ...
            // Gửi AJAX request với context path đúng
            ...
            .catch(error => {
                ...
                // Hiển thị thông báo lỗi
                showNotification('Lỗi kết nối. Vui lòng thử lại! Chi tiết: ' + error.message, 'error');
            })
            .finally(() => {
                // Re-enable toggle
