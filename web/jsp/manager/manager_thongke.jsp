...
<head>
    ...
    <title>Thống kê người dùng - Happy Smile</title>
    ...
    <div class="main-content">
        ...
        <div class="chart-container">
            <div class="chart-card">
                <h3 class="activity-title">Người dùng mới theo tháng</h3>
                <div style="height: 300px; display: flex; align-items: center; justify-content: center; color: #999;">
                    ...
                    <span>Biểu đồ người dùng mới sẽ được hiển thị tại đây</span>
                </div>
            </div>
        </div>
    </div>
