...
<head>
    ...
    <title>Phân công lịch - Happy Smile</title>
...
<body>
    <div class="header">
        <div class="header-left">
            ...
            <div class="search-box">
                ...
                <input type="text" placeholder="Tìm kiếm lịch...">
            </div>
        </div>
    ...
    <div class="main-content">
        <h1 class="page-title">Phân công lịch</h1>
        <div class="activity-section">
            <h2 class="activity-title">Thêm lịch làm việc</h2>
            <form action="addSchedule" method="post">
                ...
                <label>Ngày làm việc: <input type="date" name="work_date" required></label>
                <label>Khung giờ:
        ...
        <div class="activity-section">
            <h2 class="activity-title">Danh sách lịch làm việc</h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    <c:forEach var="schedule" items="${schedules}">
                        <tr>
                            ...
                            <td>
                                <a href="editSchedule?id=${schedule.schedule_id}" class="action-btn"><i class="fas fa-edit"></i></a>
                                <a href="deleteSchedule?id=${schedule.schedule_id}" class="action-btn" onclick="return confirm('Xác nhận xóa?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
