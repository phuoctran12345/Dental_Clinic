...
<head>
    ...
    <title>Quản lý kho thuốc - Happy Smile</title>
...
<body>
    ...
    <div class="main-content">
        <h1 class="page-title">Quản lý kho thuốc</h1>
        <div class="quick-actions">
            <a href="#add-medicine" class="action-btn"><i class="fas fa-pills"></i><div>Thêm thuốc</div></a>
        </div>
        <div class="activity-section">
            <h2 class="activity-title">Danh sách thuốc</h2>
            <table>
                <thead>
                    <tr>
                        <th>ID</th>
                ...
                <tbody>
                    <c:forEach var="medicine" items="${medicines}">
                        <tr>
                            ...
                            <td>
                                <a href="editMedicine?id=${medicine.medicine_id}" class="action-btn"><i class="fas fa-edit"></i></a>
                                <a href="deleteMedicine?id=${medicine.medicine_id}" class="action-btn" onclick="return confirm('Xác nhận xóa?')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
        ...
        <div class="activity-section" id="add-medicine">
            <h2 class="activity-title">Thêm thuốc mới</h2>
            <form action="addMedicine" method="post">
                <label>Tên thuốc: <input type="text" name="name" required></label>
                <label>Đơn vị: <input type="text" name="unit" required></label>
                <label>Số lượng: <input type="number" name="quantity_in_stock" min="0" required></label>
