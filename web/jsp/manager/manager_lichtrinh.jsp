...
<head>
    ...
    <title>Lịch trình nhân viên - Happy Smile</title>
...
<body>
    ...
    <div class="main-content">
        <h1 class="page-title">Lịch trình nhân viên</h1>
        <div class="activity-section">
            <h2 class="activity-title">Lịch làm việc</h2>
            <form action="filterSchedule" method="get">
                <label>Bác sĩ:
                ...
                <label>Ngày: <input type="date" name="work_date"></label>
