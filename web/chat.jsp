<%@page import="java.util.Map" %>
    <%@page import="model.User" %>
        <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
            <% // --- Lấy thông tin người dùng đã đăng nhập từ session --- // Lấy từ User object mà LoginServlet đã set
                model.User user=(model.User) session.getAttribute("user"); Integer currentUserId=(user !=null) ?
                user.getId() : null; String currentUsername=(user !=null) ? user.getEmail() : null; String
                currentUserRole=(user !=null) ? user.getRole() : null; // DEBUG: In ra console của server để kiểm tra
                System.out.println("DEBUG (chat.jsp): Đã lấy từ Session:"); System.out.println("
                userId: " + currentUserId + " (Kiểu: " + (currentUserId != null ? currentUserId.getClass().getName() : "
                null") + ")" ); System.out.println(" username: " + currentUsername + "
