                                ...
                                <div class="col-md-6">
                                    <div class="qr-container">
                                        ...
                                        <div class="alert alert-success mb-3">
                                            ...
                                            <small>Vietcombank, BIDV, Agribank, VietinBank, Techcombank, ACB, SHB,
                                        ...
                                        <div class="payment-methods">
                                            ...
                                            <div class="alert alert-warning mb-3">
                                                ...
                                                <small class="text-muted d-block mt-1">
                                                    ⚠️ Vui lòng hoàn tất thanh toán trong thời gian này. Sau đó slot sẽ
                                        ...
                                        <div class="text-center mt-3">
                                            <button class="btn btn-outline-warning btn-sm" onclick="simulatePayment()"
                                                title="🧪 Test: Giả lập đã thanh toán qua app ngân hàng">
                                                🧪 Test: Đã thanh toán
                                            </button>
                                            <br><small class="text-muted">⚠️ Chỉ dùng để test - Hệ thống đã TẮT
                                                auto-detect giả</small>
                                            <div class="mt-2">
                                                <small>🏦 1. Quét QR bằng app ngân hàng BẤT KỲ</small><br>
                                                <small>📱 2. Chuyển khoản với số tiền CHÍNH XÁC</small><br>
                                                <small>⏰ 3. Hệ thống sẽ tự động phát hiện (timeout: 5 phút)</small>
                                            </div>
                                            <div class="mt-3">
                                                <div class="spinner-border spinner-border-sm text-primary me-2"
                                                    role="status"></div>
                                                <small class="text-muted">Chỉ phát hiện thanh toán THẬT - không có false
                                                    positive</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="countdown">
                                            ...
                                            <strong>Thời gian còn lại: <span id="countdown">05:00</span></strong>
                            ...
                            <div class="row">
                                <div class="col-12 text-center">
                                    ...
                                    <div class="alert alert-info mb-3">
                                        <h5><i class="fas fa-search me-2"></i>🔍 Phát hiện thanh toán THẬT</h5>
                                        <p class="mb-2">
                                            <strong>Hệ thống chỉ phát hiện thanh toán THẬT - không có false
                                                positive!</strong><br>
                                            <small>⏰ Timeout: 5 phút → nếu không thanh toán sẽ về trang chủ</small>
                                        </p>
                                        <div class="row text-center mt-3">
                                            <div class="col-3">
                                                <i class="fas fa-database fa-2x text-primary mb-2"></i><br>
                                                <small><strong>Database Check</strong><br>Thanh toán thật</small>
                                            </div>
                                            <div class="col-3">
                                                <i class="fas fa-bell fa-2x text-success mb-2"></i><br>
                                                <small><strong>Webhook Real</strong><br>Bank notification</small>
                                            </div>
                                            <div class="col-3">
                                                <i class="fas fa-university fa-2x text-warning mb-2"></i><br>
                                                <small><strong>VietQR API</strong><br>Transaction verify</small>
                                            </div>
                                            <div class="col-3">
                                                <i class="fas fa-clock fa-2x text-danger mb-2"></i><br>
                                                <small><strong>5 Min Timeout</strong><br>Auto redirect home</small>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <details class="mt-3">
                                        <summary class="btn btn-outline-secondary btn-sm">
                                            <i class="fas fa-cog me-1"></i>Tuỳ chọn thủ công (chỉ khi cần)
                                        </summary>
                                        <div class="mt-3">
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        <h6><i class="fas fa-info-circle me-2"></i>Hướng dẫn thanh toán (Tất cả ngân
                                            hàng):</h6>
                                        <ol class="mb-0">
                                            <li><strong>Bước 1:</strong> Mở app ngân hàng của bạn (Vietcombank, BIDV,
                                                Agribank, VietinBank, Techcombank, ACB, SHB, VPBank, TPBank, Sacombank,
                                                HDBank, MB Bank...)</li>
                                            ...
                                            <li><strong>Bước 4:</strong> Kiểm tra thông tin và xác nhận chuyển khoản
                                            </li>
                                            <li><strong>Bước 5:</strong> Ấn nút "✅ Đã chuyển khoản thành công" để hoàn
                                                tất</li>
                                        </ol>
                                        <hr>
                                        <small class="text-muted">
                                            💡 <strong>Lưu ý:</strong> VietQR hỗ trợ chuyển khoản liên ngân hàng 24/7.
