...
CREATE TABLE [dbo].[Appointment] (
 ...
 INSERT INTO [dbo].[Appointment] (patient_id, doctor_id, work_date, slot_id, status, reason,doctor_name,previous_appointment_id) VALUES
    (1, 1, '2025-12-20', 2, N'booked', N'Khám tổng quát - Lấy cao răng','toan',1),
    (1, 2, '2025-12-21', 1, N'booked', N'Tư vấn niềng răng cho con','nam',1),
    (1, 1, '2025-12-24', 1, N'booked', N'Trám răng sâu','hai',1),
    (1, 2, '2025-12-25', 2, N'booked', N'Tái khám niềng răng','khanh',1);
...
-- 1. Bảng cha (không có khóa ngoại)
CREATE TABLE [dbo].[users] (
    [user_id]       INT            IDENTITY (1, 1) NOT NULL,
    [password_hash] NVARCHAR (255) NOT NULL,
    [email]         NVARCHAR (100) NOT NULL,
...
-- 2. Bảng có khóa ngoại đến bảng cha
CREATE TABLE [dbo].[Doctors] (
    [doctor_id]      BIGINT         IDENTITY (1, 1) NOT NULL,
    [user_id]        BIGINT         NOT NULL,
    [full_name]      NVARCHAR (255) NOT NULL,
...
-- 3. Bảng có khóa ngoại đến các bảng vừa tạo ở trên
...
-- 4. Index, trigger, constraint bổ sung (sau khi bảng đã tạo xong)
-- Ví dụ cho Bills
CREATE NONCLUSTERED INDEX [IX_Bills_CreatedAt] ON [dbo].[Bills]([created_at] ASC);
CREATE NONCLUSTERED INDEX [IX_Bills_Method] ON [dbo].[Bills]([payment_method] ASC);
CREATE NONCLUSTERED INDEX [IX_Bills_Status] ON [dbo].[Bills]([payment_status] ASC);
CREATE NONCLUSTERED INDEX [IX_Bills_PatientId] ON [dbo].[Bills]([patient_id] ASC);
CREATE NONCLUSTERED INDEX [IX_Bills_OrderId] ON [dbo].[Bills]([order_id] ASC);
CREATE NONCLUSTERED INDEX [IX_Bills_ServiceId] ON [dbo].[Bills]([service_id] ASC);
...
-- Index cho Services
CREATE NONCLUSTERED INDEX [IX_Services_Name] ON [dbo].[Services]([service_name] ASC);
CREATE NONCLUSTERED INDEX [IX_Services_Price] ON [dbo].[Services]([price] ASC);
CREATE NONCLUSTERED INDEX [IX_Services_Status] ON [dbo].[Services]([status] ASC);
CREATE NONCLUSTERED INDEX [IX_Services_Category] ON [dbo].[Services]([category] ASC);

-- Index cho Staff
CREATE NONCLUSTERED INDEX [IX_Staff_HireDate] ON [dbo].[Staff]([hire_date] ASC);
CREATE NONCLUSTERED INDEX [IX_Staff_Department] ON [dbo].[Staff]([department] ASC);
CREATE NONCLUSTERED INDEX [IX_Staff_Status] ON [dbo].[Staff]([status] ASC);
CREATE NONCLUSTERED INDEX [IX_Staff_Position] ON [dbo].[Staff]([position] ASC);
CREATE NONCLUSTERED INDEX [IX_Staff_EmploymentType] ON [dbo].[Staff]([employment_type] ASC);

-- Trigger cập nhật updated_at cho Staff
GO
CREATE TRIGGER TR_Staff_UpdatedAt
ON [dbo].[Staff]
AFTER UPDATE
...
-- 5. Insert dữ liệu mẫu (sắp xếp đúng thứ tự)
-- users
insert into users ([password_hash],[email],[role],[created_at],[avatar],[updated_at]) values
(N'12345',N'manager@gmail.com',N'MANAGER','2025-05-27 17:19:59.727',null,null),
(N'12345',N'user@gmail.com',N'PATIENT','2025-05-27 17:22:05.533',null,null),
(N'12345',N'staff@gmail.com',N'STAFF','2025-05-27 17:22:37.053',null,null),
(N'12345',N'doctor@gmail.com',N'DOCTOR','2025-05-27 17:23:29.700',null,null),
(N'PATIENT',N'hashed_password_123',N'PATIENT','2025-05-27 17:25:44.323',null,null),
(N'12345',N'userr@gmail.com',N'PATIENT','2025-05-28 12:37:52.760',null,null),
(N'12345',N'phuocthde180577@fpt.edu.vn',N'PATIENT','2025-05-28 19:21:52.967',null,'2025-06-18 06:32:22.337'),
(N'12345',N'doctor1@gmail.com',N'DOCTOR','2025-06-02 06:22:04.120',null,null),
(N'123456',N'dentist1@nhakhoa.vn',N'DOCTOR','2025-06-10 17:09:53.240',null,null),
(N'123456',N'dentist2@nhakhoa.vn',N'DOCTOR','2025-06-10 17:09:53.240',null,null),
(N'123456',N'dentist3@nhakhoa.vn',N'DOCTOR','2025-06-10 17:09:53.240',null,null),
(N'123456',N'patient1@email.vn',N'PATIENT','2025-06-10 17:09:53.240',null,null),
(N'123456',N'patient2@email.vn',N'PATIENT','2025-06-10 17:09:53.240',null,null),
(N'12345',N'king123456789@gmail.com',N'PATIENT','2025-06-17 09:59:08.440',null,null),
(N'12345',N'doctor2@gmail.com',N'DOCTOR','2025-06-21 08:31:36.550',null,null),
(N'12345',N'doctor3@gmail.com',N'DOCTOR','2025-06-21 08:32:09.873',null,null),
(N'12345',N'doctor4@gmail.com',N'DOCTOR','2025-06-21 08:32:48.903',null,null),
(N'12345',N'user6@gmail.com',N'patient','2025-06-23 14:37:47.390',null,null),
(N'12345',N'user20@gmail.com',N'patient','2025-06-23 14:57:29.630',null,null),
(N'12345',N'de180577tranhongphuoc@gmail.com',N'PATIENT','2025-06-27 14:18:55.360',null,null);

-- doctors
insert into doctors ([user_id],[full_name],[phone],[address],[date_of_birth],[gender],[specialty],[license_number],[created_at],[status],[avatar]) values
(68,N'Nguyen Do Phuc Toan',N'0123456789',N'123 Đường ABC, Quận 1, TP.HCM','1985-06-15',N'male',N'Chuyên khoa răng miệng ',N'BACSITOAN001','2025-05-24 03:25:49.890',N'active',null),
(2007,N'BS. Nguyễn Văn An',N'0901234567',N'123 Đường Nguyễn Trãi, Q1, HCM','1980-01-15',N'male',N'Nha khoa tổng quát',N'NK001','2025-06-10 17:09:53.247',N'active',null),
(2008,N'BS. Trần Thị Bích',N'0912345678',N'456 Đường Lê Văn Sỹ, Q3, HCM','1985-05-20',N'female',N'Chỉnh nha - Niềng răng',N'NK002','2025-06-10 17:09:53.247',N'active',null),
(2009,N'BS. Lê Minh Cường',N'0923456789',N'789 Đường Võ Văn Tần, Q3, HCM','1978-12-10',N'male',N'Phẫu thuật hàm mặt',N'NK003','2025-06-10 17:09:53.247',N'active',null);

-- patients
insert into patients ([user_id],[full_name],[phone],[date_of_birth],[gender],[created_at],[avatar]) values
(2,N'THP',N'0358014258','2024-05-24',N'male','2025-05-26 11:15:35.770',null),
(49,N'Tran Hong Phuoc',N'0936929381','2025-05-02',N'male','2025-05-26 11:40:27.040',null),
(6,N'Tran Hong Phuoc',N'0936929381','2025-05-28',N'male','2025-05-28 12:38:03.547',null),
(7,N'PhuocTHDev',N'0936929381','2025-05-29',N'male','2025-05-28 19:22:00.753',null),
(4,N'Nguyễn Thị Mai',N'0934567890','1990-03-25',N'female','2025-06-10 17:09:53.250',null),
(5,N'Phạm Văn Hùng',N'0945678901','1988-07-08',N'male','2025-06-10 17:09:53.250',null),
(2011,N'king',N'0936929381','2025-06-23',N'male','2025-06-23 14:57:43.747',null),
(2012,N'Trương Gia Bình ',N'0936929382','2004-06-05',N'male','2025-06-27 14:19:27.610',null);

-- services
insert into services ([service_name],[description],[price],[status],[category],[created_at],[updated_at],[created_by],[image]) values
(N'Khám tổng quát răng miệng',N'Kiểm tra sức khỏe răng miệng tổng quát, tư vấn chăm sóc răng',200000,N'active',N'Khám cơ bản','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://b2976109.smushcdn.com/2976109/wp-content/uploads/2019/04/tooth_anatomy.jpg?lossy=2&strip=1&webp=1'),
(N'Khám tổng quát',N'Khám răng tổng quát, tư vấn chăm sóc răng miệng',100000,N'active',N'Khám cơ bản','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://www.vinmec.com/static/uploads/medium_20190626_104545_053307_kham_rang_max_1800x1800_jpg_809c6546f2.jpg'),
(N'Cạo vôi răng',N'Làm sạch mảng bám, vôi răng, đánh bóng răng',10000,N'active',N'Vệ sinh răng','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://nhakhoadrgreen.vn/wp-content/uploads/2025/04/cach-lam-sach-cao-rang-tai-nha-1-1024x684.jpg'),
(N'Lấy cao răng',N'Vệ sinh răng miệng, lấy cao răng, đánh bóng răng',200000,N'active',N'Vệ sinh răng','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://www.nhakhoavietducdn.vn/wp-content/uploads/2019/12/co-nen-lay-cao-rang-thuong-xuyen-khong-180-1.jpg'),
(N'Trám răng sâu',N'Trám răng sâu bằng composite, amalgam',500000,N'active',N'Điều trị','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://nhakhoaviethan.vn/wp-content/uploads/2022/12/Thiet-ke-chua-co-ten-4.png'),
(N'Trám răng sâu composite',N'Điều trị và trám răng bị sâu với vật liệu composite',300000,N'active',N'Điều trị','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://nhakhoamientay.com/wp-content/uploads/2021/04/tram-rang-composite-la-gi.jpg'),
(N'Điều trị tủy răng',N'Điều trị viêm tủy, chữa tủy răng',1000000,N'active',N'Điều trị','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'https://login.medlatec.vn//ImagePath/images/20210819/20210819_tai-sao-can-phai-dieu-tri-tuy-rang-1.jpg'),
(N'Nhổ răng khôn',N'Nhổ răng khôn mọc lệch, mọc ngầm',1500000,N'active',N'Phẫu thuật','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/wisdom-tooth.jpg'),
(N'Nhổ răng khôn an toàn',N'Phẫu thuật nhổ răng khôn an toàn',800000,N'active',N'Phẫu thuật','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,null),
(N'Bọc răng sứ',N'Bọc răng sứ thẩm mỹ, phục hồi răng hư tổn',3000000,N'active',N'Thẩm mỹ','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/dental-crown.jpg'),
(N'Tẩy trắng răng',N'Tẩy trắng răng bằng công nghệ laser',2000000,N'active',N'Thẩm mỹ','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/teeth-whitening.jpg'),
(N'Niềng răng',N'Niềng răng chỉnh nha, điều chỉnh khớp cắn',5000000,N'active',N'Chỉnh nha','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/braces.jpg'),
(N'Niềng răng kim loại',N'Chỉnh nha với mắc cài kim loại truyền thống',15000000,N'active',N'Chỉnh nha','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,null),
(N'Niềng răng invisalign',N'Chỉnh nha trong suốt hiện đại',45000000,N'active',N'Chỉnh nha','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,null),
(N'Chụp X-quang răng',N'Chụp X-quang răng toàn cảnh, chẩn đoán bệnh lý',300000,N'active',N'Chẩn đoán','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/dental-xray.jpg'),
(N'Làm răng giả tháo lắp',N'Làm răng giả tháo lắp, phục hồi răng mất',2000000,N'active',N'Phục hình','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,N'/images/dentures.jpg'),
(N'Tư vấn niềng răng',N'Khám và tư vấn phương pháp chỉnh nha phù hợp',150000,N'active',N'Tư vấn','2025-06-11 18:37:32.0733333','2025-06-11 18:37:32.0733333',null,null),
(N'Bán thuốc trực tiếp',N'Dịch vụ bán thuốc trực tiếp tại quầy nhà thuốc. Khách hàng có thể mua thuốc theo đơn thuốc hoặc mua lẻ các loại thuốc không kê đơn.',0,N'active',N'PHARMACY','2025-06-27 14:58:28.8733333','2025-06-27 14:58:28.8733333',N'SYSTEM',N'https://cdn-icons-png.flaticon.com/512/883/883356.png');

-- medicine
insert into medicine ([name],[unit],[quantity_in_stock],[description]) values
(N'Paracetamol 500mg',N'Viên',984,N'Thuốc giảm đau, hạ sốt'),
(N'Amoxicillin 500mg',N'Viên',799,N'Kháng sinh điều trị nhiễm khuẩn'),
...
-- staff
insert into staff ([user_id],[full_name],[phone],[address],[date_of_birth],[gender],[position],[employment_type],[created_at],[updated_at],[status],[hire_date],[salary],[manager_id],[department],[work_schedule],[notes]) values
(2,N'STAFF',N'0936929381',N'16 chuong duong','2024-05-24',N'male',N'TIEP TAN',N'fulltime','2025-06-30 09:40:42.4266667','2025-06-30 09:40:42.7966667',N'active','2025-06-30',null,null,N'General',N'full_day',null); 