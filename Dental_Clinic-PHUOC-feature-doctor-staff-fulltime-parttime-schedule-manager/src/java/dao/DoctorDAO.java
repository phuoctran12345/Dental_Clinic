...
public class DoctorDAO {
        ...
        try (Connection conn = DBContext.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                while (rs.next()) {
                    ...
                    // Debug log
                    System.out.println("DEBUG - Loaded appointment: ID=" + appointment.getAppointmentId() 
                            + ", Patient=" + appointment.getPatientName() 
                            + ", Status=" + appointment.getStatus());
                }
            }
        } catch (SQLException e) {
            System.err.println("Error in getAppointmentsByUserId: " + e.getMessage());
            e.printStackTrace();
        }
        return appointments;
    }
    ...
    public static List<String> getAllSpecialties() {
        ...
        public static Doctors getDoctorById(long doctorId) throws SQLException {
        Doctors doctor = null;
    ...
    /*-------------------------------------------------------------*/
    /* CÁC HÀM HỖ TRỢ MEDICAL REPORT & PRESCRIPTION */
    /*-------------------------------------------------------------*/
     ...
     */
    public static List<MedicalReport> getMedicalReportsByDoctorId(long doctorId) throws SQLException {
