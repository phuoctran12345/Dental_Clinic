...
public class CompletedAppointmentsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (doctor == null) {
            System.out.println("❌ Không tìm thấy doctor cho userId: " + user.getUserId());
            ...
            if (allAppointments != null) {
                completedAppointments = allAppointments.stream()
                    .filter(appointment -> "completed".equalsIgnoreCase(appointment.getStatus()) ||
                                         ...
                                         "Đã khám".equalsIgnoreCase(appointment.getStatus()) ||
                                         "Hoàn thành".equalsIgnoreCase(appointment.getStatus()))
