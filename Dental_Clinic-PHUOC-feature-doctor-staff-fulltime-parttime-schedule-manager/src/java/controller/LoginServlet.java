...
public class LoginServlet extends HttpServlet {
   ...
   private static final String CLIENT_ID = "abc ";
            ...
            try {
                ...
                if (responseCode == HttpURLConnection.HTTP_OK) {
                    ...
                    if (user != null) {
                        ...
                        System.out.println("[DEBUG] Login thành công - role=" + user.getRole() + ", userId=" + user.getUserId());

                        Patients patient = UserDAO.getPatientByUserId(user.getUserId());
                        ...
                        if ("DOCTOR".equalsIgnoreCase(role)) {
                            ...
                            if (doctor != null) {
                                ...
                                System.out.println("Google login - Không tìm thấy doctor theo user_id: " + user.getUserId());
                            }
    ...
    if (doctor != null) {
        ...
        System.out.println("Form login - Không tìm thấy doctor theo user_id: " + user.getUserId());
    }
    response.sendRedirect(request.getContextPath() + "/DoctorHomePageServlet");
