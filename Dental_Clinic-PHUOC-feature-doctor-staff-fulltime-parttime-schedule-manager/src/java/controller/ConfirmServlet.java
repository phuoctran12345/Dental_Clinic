...
public class ConfirmServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("User found - ID: " + user.getUserId() + ", Username: " + user.getUsername());
            
            // Lấy patient_id từ bảng Patients dựa vào user_id
            dao.PatientDAO patientDAO = new dao.PatientDAO();
            model.Patients patient = dao.PatientDAO.getPatientByUserId(user.getUserId());
            if (patient == null) {
                System.out.println("ERROR: Không tìm thấy patient record cho user_id: " + user.getUserId());
