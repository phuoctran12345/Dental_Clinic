    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <body>
            <div class="container mt-5">
                ...
                <form action="${pageContext.request.contextPath}/DoctorRegisterScheduleServlet" method="POST" class="mt-4">
                    <div class="mb-3">
                        <label for="doctor_id" class="form-label">Mã bác sĩ</label>
                        <input type="number" class="form-control" id="doctor_id" name="doctor_id" required value="${param.doctor_id != null ? param.doctor_id : ''}">
                    </div>
                    <div class="mb-3">
