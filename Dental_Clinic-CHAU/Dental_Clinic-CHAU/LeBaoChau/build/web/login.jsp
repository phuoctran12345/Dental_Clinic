...
<html lang="vi">
    ...
    <body>
        <!-- Ghi chú: Container chứa form đăng nhập, căn trái -->
        <div class="login-container">
            ...
            <form action="LoginServlet" method="post">
                ...
                <!-- Ghi chú: Liên kết đăng ký và quên mật khẩu -->
                <p class="text-center mt-3">
                    <a href="signup.jsp">Đăng ký</a> | <a href="#">Quên mật khẩu?</a>
                </p>
                <!-- Ghi chú: Liên kết quay về trang chủ -->
                <p class="text-center mt-3">
                    <a href="<%= request.getContextPath()%>/user_homepage.jsp" style="color: #3b82f6;">Trang chủ</a>
                </p>
            </form>
        </div>
