    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            .hero {
                background: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.3)), url('jsp/img/banner2.jpg') no-repeat center center fixed;
                color: #112ff2;
                padding: 100px 0;
                text-align: center;
                position: relative;
    ...
    <body>
        <header class="header">
            <div class="header-top">
                <div class="logo">
                    <img src="jsp/img/logo.png" alt="HAPPY Smile Logo">
        ...
        <section class="about" id="about">
            ...
            <div class="about-content">
                ...
                <div class="about-image">
                    <img src="jsp/img/bacsii.png" alt="Phòng khám HAPPY Smile">
                </div>
            </div>
        </section>
            ...
            <div class="service-container">
                <div class="service-row">
                    <div class="service-item">
                        <img src="jsp/img/icon1.jpg" alt="Khám tổng quát" class="service-icon">
                        <p data-lang="service-general-checkup">Khám tổng quát</p>
                    </div>
                    <div class="service-item">
                        <img src="jsp/img/icon2.jpg" alt="Trám răng" class="service-icon">
                        <p data-lang="service-filling">Trám răng</p>
                    </div>
                    <div class="service-item">
                        <img src="jsp/img/icon3.jpg" alt="Tẩy trắng răng" class="service-icon">
                        <p data-lang="service-whitening">Tẩy trắng răng</p>
                    </div>
                    <div class="service-item">
                        <img src="jsp/img/icon4.jpg" alt="Bọc răng sứ" class="service-icon">
                        <p data-lang="service-veneers">Bọc răng sứ</p>
                    </div>
                </div>
                <div class="service-row">
                    <div class="service-item">
                        <img src="jsp/img/icon5.jpg" alt="Niềng răng" class="service-icon">
                        <p data-lang="service-braces">Niềng răng</p>
                    </div>
                    <div class="service-item">
                        <img src="jsp/img/icon6.jpg" alt="Nhổ răng" class="service-icon">
                    ...
                    <div class="service-item">
                        <img src="jsp/img/icon8.jpg" alt="Điều trị nha chu" class="service-icon">
            ...
            <div class="team-slider">
                <div class="doctor-card">
                    <div class="doctor-image">
                        <img src="jsp/img/bacsi1.png" alt="Bác sĩ Nguyễn Văn A">
                    </div>
                ...
                <div class="doctor-card">
                    <div class="doctor-image">
                        <img src="jsp/img/bacsi2.png" alt="Bác sĩ Trần Thị B">
                    </div>
                    <div class="doctor-info">
                        <h4>Bs. Trần Thị B</h4>
                ...
                <div class="doctor-card">
                    <div class="doctor-image">
                        <img src="jsp/img/bacsi3.png" alt="Bác sĩ Lê Văn C">
                    </div>
                    <div class="doctor-info">
                        <h4>Bs. Lê Văn C</h4>
                ...
                <div class="doctor-card">
                    <div class="doctor-image">
                        <img src="jsp/img/bacsi4.png" alt="Bác sĩ Phạm Thị D">
                    </div>
                    <div class="doctor-info">
                        <h4>Bs. Phạm Thị D</h4>
            ...
            <div class="news-grid">
                <div class="news-card">
                    <div class="news-image">
                        <img src="jsp/img/placeholder-news.png" alt="Cách chăm sóc răng miệng">
                    </div>
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="jsp/img/placeholder-news.png" alt="Niềng răng trong suốt">
                    </div>
                    <div class="news-content">
                ...
                <div class="news-card">
                    <div class="news-image">
                        <img src="jsp/img/placeholder-news.png" alt="Phòng ngừa sâu răng">
                    </div>
                    <div class="news-content">
        ...
        // Language switching function
            ...
            document.addEventListener('DOMContentLoaded', () => {
                translatableElements = document.querySelectorAll('[data-lang]');
        ...
        // Handle elements with HTML content (e.g., contact-hours-open/closed)
        if (element.innerHTML.includes('<span')) {
                                             ...
                                             // Keyboard shortcuts for language and theme
                                             document.addEventListener('keydown', (e) => {
                                             if (e.altKey && e.key === 'v') {
                                             switchLanguage('vi');
                                             document.getElementById('language-switcher').value = 'vi';
                                             } else if (e.altKey && e.key === 'e') {
                                             switchLanguage('en');
                                             document.getElementById('language-switcher').value = 'en';
                                             } else if (e.altKey && e.key === 'j') {
                                             switchLanguage('ja');
                                             document.getElementById('language-switcher').value = 'ja';
