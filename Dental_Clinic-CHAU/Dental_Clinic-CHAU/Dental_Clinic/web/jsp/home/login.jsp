                                    ...
                                    <form id="login-form" action="LoginServlet" method="post">
                                        ...
                                        <div  style="margin-top: 10px" class="login_submit">
                                         ...
                                         <div style="margin-top: 20px">
                                            <a class="login-with-google-btn" href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile&redirect_uri=http://localhost:8080/ShopUpdate/DispatchServlet?btnAction=Login&response_type=code
                                               &client_id=20308864160-adugjk9b6q5m259igej77ho5lr1lffrq.apps.googleusercontent.com&approval_prompt=force">Login With Google</a>
